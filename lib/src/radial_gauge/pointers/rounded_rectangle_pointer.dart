...
class RoundedRectanglePointer extends Equatable implements GaugePointer {
  final double width;
  final double height;
  ...
  Path get path =>
      roundedPoly([
        // bottom left
        VertexDefinition(0, height, radius: width / 2),
        // bottom right
        VertexDefinition(width, height, radius: width / 2),
        // top left
